...
This demo is the works of Nick Cerminara, I found it on scotch.io

I liked the idea of implementing JWT without passport, so that is the reason behind pushing this up as
a valid implementation. FYI I did make a few modifications to the code but nothing to drastic
